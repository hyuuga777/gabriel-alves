        ...
        <div className="min-h-screen bg-[#0a0a0a] text-gray-100 flex">
            ...
            <aside className="hidden lg:flex flex-col w-64 fixed inset-y-0 left-0 bg-[#111111] border-r border-white/5 z-50">
                <div className="h-16 flex items-center px-6 border-b border-white/5">
                    <span className="text-xl font-bold text-white tracking-tight uppercase">Team Alves<span className="text-primary">.</span></span>
                </div>
                ...
                <div className="p-4 border-t border-white/5">
                    <button className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-400 hover:text-red-400 transition-colors w-full rounded-lg hover:bg-red-500/10">
