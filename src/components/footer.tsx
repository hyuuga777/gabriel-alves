        ...
        <footer className="bg-background border-t border-white/5 pt-16 pb-8 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-4">
                        <Link href="/" className="flex items-center gap-2">
                            <img src="https://ogabrielalves.com/logo.png" alt="Team Alves" className="h-[54px] w-auto object-contain opacity-100 transition-all" />
                        </Link>
                ...
                <div className="border-t border-white/5 pt-8 text-center text-sm text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} Team Alves. Todos os direitos reservados.</p>
                </div>
            </div>
        </footer>
    );
